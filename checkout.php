...
<section class="checkout-orders">
   ...
   <h3>your orders</h3>
      ...
      ?>
         <p> <?= $fetch_cart['name']; ?> <span>(<?= '₱'.$fetch_cart['price'].'.00 x '. $fetch_cart['quantity']; ?>)</span> </p>
      <?php
            }
         }else{
      ...
      ?>
         ...
         <div class="grand-total">Total : <span>₱<?= $grand_total; ?>.00</span></div>
      </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>state :</span>
            <input type="text" name="state" placeholder="e.g. Metro Manila" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>country :</span>
