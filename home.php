            ...
            <div id="carouselExampleIndicators" class="carousel slide sld" data-bs-ride="true">
               ...
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <img src="images/img1.jpg" id="img1" class="d-block w-100 img-home" alt="...">
                     <div class="carousel-caption">
                        <p>New Arrival</p>
                     </div>
                  </div>
                  <div class="carousel-item">
                     <img src="images/img2.jpg" id="img2" class="d-block w-100 img-home" alt="...">
                     <div class="carousel-caption">
                        <p>On the week</p>
                     </div>
                  </div>
                  <div class="carousel-item">
                     <img src="images/img3.jpg" id="img3" class="d-block w-100 img-home" alt="...">
                     <div class="carousel-caption">
